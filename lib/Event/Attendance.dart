...
class attendanceScreen extends StatefulWidget {
  ...
  bool multiday;
  String eid;
  attendanceScreen({Key? key,required this.data,required this.multiday,required this.eid}) : super(key: key);
  ...
  populateItems() async{
    if(widget.multiday){
      for(var i in widget.data){
        ...
        Map atends = m['attend'] as Map;
        List aas = atends.keys.toList();
        aas.remove("id");

        bool isat = atends.keys.toList().length > 1;
        if(m['id'] != "id"){
          Map p = {
            'id':m['id'],
            'name':m['name'],
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  mainText(attendS, textColor, 10.0, FontWeight.bold, 4),
                ],
              ),
              Spacer(),
